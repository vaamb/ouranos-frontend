import {
  faHome, faCloud, faThermometerHalf, faCog, faServer, faSeedling,
  faHeartbeat, faToggleOff, faVideo, faDatabase
...
export const generateMenuLayout = function(currentUser, ecosystemsIds, ecosystemsManagement, enginesIds, weatherEnabled) {
  let menuLayout = {
    title: "GAIA",
    items: [
      MenuItem("Home", faHome, "/"),
    ],
  };

  if (weatherEnabled === true) {
    menuLayout.items.push(
            MenuItem("Weather Forecast", faCloud, "weather"),
    );
  }
